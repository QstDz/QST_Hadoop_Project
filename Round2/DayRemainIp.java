...
public class DayRemainIp {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJobName("DayRemainIp");
		job.setJarByClass(DayRemainIp.class);
		...
		if(status){
			...
			System.out.println(args[2]+"day and "+args[3]+"day's RemainIp---"+(double)counter2.getValue()/counter.getValue());
		}
	}
